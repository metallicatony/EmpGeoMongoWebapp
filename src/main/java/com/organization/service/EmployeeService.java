...
public interface EmployeeService {
	...
	@GET
	@Path("/")
	public Response getAllEmployees(@QueryParam("lname") String lname, @QueryParam("address") String address, @QueryParam("radius") String radius);
	...
	@PUT
	@Path("/{empid}")
	public Response updateEmployee(@PathParam("empid") String empId, EmployeeRequest employeeRequest);
